...
# Output Directory
BASE_DIR = r"C:\Users\jwk72\all_about_code\soccer_predict_system\Dacon_Submission_Package\4_Documents\Final_Project_Report"
if not os.path.exists(BASE_DIR):
    os.makedirs(BASE_DIR)

chapters = {}

chapters['01_Project_Objective.md'] = """# 1. 프로젝트 목적 및 개요 (Project Objective)
...
chapters['02_Domain_Background.md'] = """# 2. 도메인 배경 지식 (Domain Background)
...
chapters['03_Data_Specification.md'] = """# 3. 데이터 명세 및 구조 (Data Specification)
...
chapters['04_Rules_and_Compliance.md'] = """# 4. 규칙 및 규정 준수 (Rules & Compliance)
...
chapters['05_EDA_Coordinates_Distribution.md'] = """# 5. EDA 1: 좌표 및 공간 분포 분석 (Coordinates Distribution)
...
chapters['06_EDA_Player_Analysis.md'] = """# 6. EDA 2: 선수별 성향 분석 (Player Analysis)
...
chapters['07_EDA_Sequence_Patterns.md'] = """# 7. EDA 3: 시퀀스 및 템포 분석 (Sequence Patterns)
...
chapters['08_Preprocessing_Strategy.md'] = """# 8. 데이터 전처리 전략 (Preprocessing Strategy)
...
chapters['09_Feature_Engineering_Basic.md'] = """# 9. 특성 공학 1: 기초 변수 (Feature Engineering - Basic)
...
chapters['10_Feature_Engineering_Advanced_Player.md'] = """# 10. 특성 공학 2: 선수 고유 특성 (Feature Engineering - Advanced)
...
chapters['11_Feature_Selecton_drop_leakage.md'] = """# 11. 특성 선택 및 누수 방지 (Feature Selection & Anti-Leakage)
...
chapters['12_Model_XGBoost.md'] = """# 12. 모델 1: XGBoost (Extreme Gradient Boosting)
...
chapters['13_Model_LightGBM.md'] = """# 13. 모델 2: LightGBM (Light Gradient Boosting Machine)
...
chapters['14_Model_LSTM_Concept.md'] = """# 14. 모델 3: LSTM 개념 및 도입 배경 (LSTM Concept)
...
chapters['15_Model_LSTM_Architecture.md'] = """# 15. 모델 3: LSTM 아키텍처 상세 (LSTM Architecture)
...
chapters['16_Training_Validation_Strategy.md'] = """# 16. 학습 및 검증 전략 (Training & Validation)
...
chapters['17_Ensemble_Methodology.md'] = """# 17. 앙상블 방법론 (Ensemble Methodology)
...
chapters['18_Quantitative_Results.md'] = """# 18. 정량적 분석 결과 (Quantitative Results)
...
chapters['19_Qualitative_Analysis.md'] = """# 19. 정성적 분석 및 해석 (Qualitative Analysis)
...
chapters['20_Conclusion_Future_Work.md'] = """# 20. 결론 및 향후 과제 (Conclusion & Future Work)
...
print("All 20 chapters created successfully.")

# Create Combined Report
with open(os.path.join(BASE_DIR, 'Combined_Final_Report.md'), 'w', encoding='utf-8') as outfile:
    for filename in sorted(chapters.keys()):
        outfile.write(chapters[filename])
        outfile.write("\n\n---\n\n")
